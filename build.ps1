<#
.SYNOPSIS
    Build the Windows desktop app into dist\dh-pdf-trans and zip it for release.
...
$output = Join-Path $root "dist\dh-pdf-trans"
...
$running = Get-Process -Name "dh-pdf-trans" -ErrorAction SilentlyContinue |
...
$archive = Join-Path $root "dist\dh-pdf-trans-windows.zip"
